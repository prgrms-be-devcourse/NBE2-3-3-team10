...
interface LaundryShopRepository : JpaRepository<LaundryShop?, Long?> {
    ...
    fun findByShopNameContaining(@Param("shop_name") shopName: String?): MutableList<LaundryShop?>

    fun findByIdIn(ids: List<Int?>?): MutableList<LaundryShop?>

    fun findByUserId(userId: Int): Optional<LaundryShop>

    fun findById(id: Int): Optional<LaundryShop>
}
